...
elf_file = Debouncing.elf                #This is the variable created to store the elf file
c_file = deb-final.c                     #This is the variable created to store the c file
hex_file = Debouncing.hex                # It is the variable created to store the hex file
objs = Debouncing.elf Debouncing.hex     # This variable stores all the object files that will be created during the execution of code
